module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  llvm.func @_Z34print_number_vendor_ids_and_uniquev() {
    ...
    %7 = llvm.call @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(%6) : (!llvm.ptr<i8>) -> !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>
    %8 = llvm.call @remote_vec_size_int(%7) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    ...
    %12 = llvm.call @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(%6) : (!llvm.ptr<i8>) -> !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>
    %13 = llvm.call @_Z21get_col_unique_valuesIiEmRKSt6vectorIT_SaIS1_EE(%12) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    %14 = llvm.call @printf(%11, %13) : (!llvm.ptr<i8>, i64) -> i32
    llvm.return
  }
  llvm.func @remote_vec_size_int(%arg0: !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64 {
  ...
  llvm.func @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(!llvm.ptr<i8>) -> !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>> attributes {sym_visibility = "private"}
  llvm.func linkonce_odr @_Z21get_col_unique_valuesIiEmRKSt6vectorIT_SaIS1_EE(%arg0: !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64 {
    %0 = llvm.mlir.constant(0 : i64) : i64
    ...
    %20 = llvm.call @remote_vec_size_int(%arg0) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    ...
    llvm.call @_ZNSt6vectorIiSaIiEE7reserveEm(%19, %20) : (!llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, i64) -> ()
    %21 = llvm.add %20, %13  : i64
    %22 = llvm.sdiv %21, %12  : i64
    %23 = llvm.alloca %11 x i32 : (i32) -> !llvm.ptr<i32>
    llvm.br ^bb1(%14 : i64)
  ^bb1(%24: i64):  // 2 preds: ^bb0, ^bb2
    %25 = llvm.icmp "slt" %24, %10 : i64
    llvm.cond_br %25, ^bb2, ^bb3
  ^bb2:  // pred: ^bb1
    %26 = llvm.mul %24, %8  : i64
    %27 = llvm.trunc %24 : i64 to i32
    %28 = llvm.call @remote_vec_idx_int(%arg0, %26) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, i64) -> !llvm.ptr<i32>
    %29 = llvm.ptrtoint %28 : !llvm.ptr<i32> to i64
    %30 = llvm.and %29, %5  : i64
    %31 = llvm.udiv %30, %4  : i64
    %32 = llvm.srem %31, %3  : i64
    %33 = llvm.trunc %32 : i64 to i32
    %34 = llvm.call @cache_request_impl_1(%2, %30, %33, %1) : (i32, i64, i32, i8) -> i32
    %35 = llvm.sext %27 : i32 to i64
    %36 = llvm.getelementptr %23[%35] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    llvm.store %33, %36 : !llvm.ptr<i32>
    %37 = llvm.add %24, %9  : i64
    llvm.br ^bb1(%37 : i64)
  ^bb3:  // pred: ^bb1
    llvm.br ^bb4(%14 : i64)
  ^bb4(%38: i64):  // 2 preds: ^bb3, ^bb16
    %39 = llvm.icmp "slt" %38, %22 : i64
    llvm.cond_br %39, ^bb5, ^bb17
  ^bb5:  // pred: ^bb4
    %40 = llvm.add %38, %7  : i64
    %41 = llvm.icmp "slt" %40, %22 : i64
    llvm.cond_br %41, ^bb6, ^bb7
  ^bb6:  // pred: ^bb5
    %42 = llvm.srem %40, %6  : i64
    %43 = llvm.trunc %42 : i64 to i32
    %44 = llvm.mul %40, %8  : i64
    %45 = llvm.call @remote_vec_idx_int(%arg0, %44) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, i64) -> !llvm.ptr<i32>
    %46 = llvm.ptrtoint %45 : !llvm.ptr<i32> to i64
    %47 = llvm.and %46, %5  : i64
    %48 = llvm.udiv %47, %4  : i64
    %49 = llvm.srem %48, %3  : i64
    %50 = llvm.trunc %49 : i64 to i32
    %51 = llvm.call @cache_request_impl_1(%2, %47, %50, %1) : (i32, i64, i32, i8) -> i32
    %52 = llvm.sext %43 : i32 to i64
    %53 = llvm.getelementptr %23[%52] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    llvm.store %50, %53 : !llvm.ptr<i32>
    llvm.br ^bb7
  ^bb7:  // 2 preds: ^bb5, ^bb6
    %54 = llvm.mul %38, %8  : i64
    %55 = llvm.call @remote_vec_idx_int(%arg0, %54) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, i64) -> !llvm.ptr<i32>
    %56 = llvm.srem %38, %6  : i64
    %57 = llvm.getelementptr %23[%56] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    %58 = llvm.load %57 : !llvm.ptr<i32>
    %59 = llvm.sext %58 : i32 to i64
    %60 = llvm.mlir.addressof @tokens : !llvm.ptr<array<33554432 x struct<(i64, i8, i8, i16, i32)>>>
    %61 = llvm.getelementptr %60[0, 0] : (!llvm.ptr<array<33554432 x struct<(i64, i8, i8, i16, i32)>>>) -> !llvm.ptr<struct<(i64, i8, i8, i16, i32)>>
    %62 = llvm.getelementptr %61[%59] : (!llvm.ptr<struct<(i64, i8, i8, i16, i32)>>, i64) -> !llvm.ptr<struct<(i64, i8, i8, i16, i32)>>
    %63 = llvm.getelementptr %62[0, 3] : (!llvm.ptr<struct<(i64, i8, i8, i16, i32)>>) -> !llvm.ptr<i16>
    %64 = llvm.load %63 : !llvm.ptr<i16>
    llvm.call @poll_qid1(%2, %64) : (i32, i16) -> ()
    %65 = llvm.ptrtoint %55 : !llvm.ptr<i32> to i64
    %66 = llvm.mul %59, %4  : i64
    %67 = llvm.srem %65, %4  : i64
    ...
    %74 = llvm.add %38, %16  : i64
    %75 = llvm.mul %74, %12  : i64
    %76 = llvm.icmp "sgt" %20, %75 : i64
    llvm.cond_br %76, ^bb8, ^bb9
  ^bb8:  // pred: ^bb7
    llvm.br ^bb10(%12 : i64)
  ^bb9:  // pred: ^bb7
    %77 = llvm.mul %38, %12  : i64
    %78 = llvm.sub %20, %77  : i64
    llvm.br ^bb10(%78 : i64)
  ^bb10(%79: i64):  // 2 preds: ^bb8, ^bb9
    llvm.br ^bb11
  ^bb11:  // pred: ^bb10
    %80 = llvm.mul %38, %12  : i64
    llvm.br ^bb12(%14 : i64)
  ^bb12(%81: i64):  // 2 preds: ^bb11, ^bb15
    %82 = llvm.icmp "slt" %81, %79 : i64
    llvm.cond_br %82, ^bb13, ^bb16
  ^bb13:  // pred: ^bb12
    %83 = llvm.add %81, %80  : i64
    %84 = llvm.getelementptr %73[%81] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    %85 = llvm.call @remote_vec_idx_int(%arg0, %83) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, i64) -> !llvm.ptr<i32>
    %86 = llvm.load %84 : !llvm.ptr<i32>
    llvm.store %86, %17 : !llvm.ptr<i32>
    %87 = llvm.call @_Z15step1_firstTimei(%86) : (i32) -> i8
    %88 = llvm.icmp "ne" %87, %15 : i8
    llvm.cond_br %88, ^bb14, ^bb15
  ^bb14:  // pred: ^bb13
  ...
  ^bb15:  // 2 preds: ^bb13, ^bb14
    %89 = llvm.add %81, %9  : i64
    llvm.br ^bb12(%89 : i64)
  ^bb16:  // pred: ^bb12
    %90 = llvm.add %38, %9  : i64
    llvm.br ^bb4(%90 : i64)
  ^bb17:  // pred: ^bb4
    %91 = llvm.call @_ZNKSt6vectorIiSaIiEE4sizeEv(%19) : (!llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    llvm.return %91 : i64
  }
  ...
  llvm.func linkonce_odr @remote_vec_idx_int(%arg0: !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, %arg1: i64) -> !llvm.ptr<i32> {
    %0 = llvm.getelementptr %arg0[0, 0] : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> !llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>>
    %1 = llvm.getelementptr %0[0, 0] : (!llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>>) -> !llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>>
    %2 = llvm.getelementptr %1[0, 0] : (!llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>>) -> !llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>>
    %3 = llvm.getelementptr %2[0, 0] : (!llvm.ptr<struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>>) -> !llvm.ptr<ptr<i32>>
