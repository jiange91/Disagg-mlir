module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z34print_number_vendor_ids_and_uniquev() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %7 = call @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(%6) : (!llvm.ptr<i8>) -> !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>
    %8 = call @remote_vec_size_int(%7) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64
    ...
    %12 = call @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(%6) : (!llvm.ptr<i8>) -> !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>
    %13 = call @_Z21get_col_unique_valuesIiEmRKSt6vectorIT_SaIS1_EE(%12) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64
    %14 = llvm.call @printf(%11, %13) : (!llvm.ptr<i8>, i64) -> i32
    return
  }
  func.func @remote_vec_size_int(%arg0: !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64 attributes {llvm.linkage = #llvm.linkage<external>} {
  ...
  func.func private @_Z10get_columnIiERSt6vectorIT_SaIS1_EEPKc(!llvm.ptr<i8>) -> !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>> attributes {llvm.linkage = #llvm.linkage<external>}
  func.func @_Z21get_col_unique_valuesIiEmRKSt6vectorIT_SaIS1_EE(%arg0: !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64 attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    ...
    %3 = call @remote_vec_size_int(%arg0) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> i64
    ...
    %4 = arith.addi %3, %c524287_i64 : i64
    %5 = arith.divsi %4, %c524288_i64 : i64
    %6 = llvm.alloca %c9_i32 x i32 : (i32) -> !llvm.ptr<i32>
    scf.for %arg1 = %c0 to %c8 step %c1 {
      %9 = arith.muli %arg1, %c524288 : index
      %10 = arith.index_cast %arg1 : index to i32
      %11 = arith.index_cast %9 : index to i64
      %12 = func.call @remote_vec_idx_int(%arg0, %11) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %13 = rmem.request 1, %12 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
      %14 = arith.extsi %10 : i32 to i64
      %15 = llvm.getelementptr %6[%14] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
      llvm.store %13, %15 : !llvm.ptr<i32>
    }
    %7 = arith.index_cast %5 : i64 to index
    scf.for %arg1 = %c0 to %7 step %c1 {
      %9 = arith.index_cast %arg1 : index to i64
      %10 = arith.addi %9, %c8_i64 : i64
      %11 = arith.cmpi slt, %10, %5 : i64
      scf.if %11 {
        %25 = arith.remsi %10, %c9_i64 : i64
        %26 = arith.trunci %25 : i64 to i32
        %27 = arith.index_cast %10 : i64 to index
        %28 = arith.muli %27, %c524288 : index
        %29 = arith.index_cast %28 : index to i64
        %30 = func.call @remote_vec_idx_int(%arg0, %29) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
        %31 = rmem.request 1, %30 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
        %32 = arith.extsi %26 : i32 to i64
        %33 = llvm.getelementptr %6[%32] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
        llvm.store %31, %33 : !llvm.ptr<i32>
      }
      %12 = arith.muli %arg1, %c524288 : index
      %13 = arith.index_cast %12 : index to i64
      %14 = func.call @remote_vec_idx_int(%arg0, %13) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %15 = arith.remsi %9, %c9_i64 : i64
      %16 = llvm.getelementptr %6[%15] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
      %17 = llvm.load %16 : !llvm.ptr<i32>
      rmem.poll 1, %17, 0 : (i32) -> ()
      %18 = rmem.paddr 1, %17, %14 : (i32, !rmem.rmref<1, !llvm.ptr<i32>>) -> !llvm.ptr<i32>
      %19 = arith.addi %9, %c1_i64 : i64
      %20 = arith.muli %19, %c524288_i64 : i64
      %21 = arith.cmpi sgt, %3, %20 : i64
      %22 = scf.if %21 -> (i64) {
        scf.yield %c524288_i64 : i64
      } else {
        %25 = arith.muli %9, %c524288_i64 : i64
        %26 = arith.subi %3, %25 : i64
        scf.yield %26 : i64
      }
      %23 = arith.muli %9, %c524288_i64 : i64
      ...
      scf.for %arg2 = %c0 to %24 step %c1 {
        ...
        %28 = rmem.llvm.getelementptr %18[%27 []] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>, i32
        %29 = rmem.from_addr %28 : (!llvm.ptr<i32>) -> !rmem.rmref<0, !llvm.ptr<i32>>
        %30 = arith.index_cast %26 : index to i64
        %31 = func.call @remote_vec_idx_int(%arg0, %30) : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
        %32 = rmem.llvm.load %29 : (!rmem.rmref<0, !llvm.ptr<i32>>) -> i32
        rmem.llvm.store %32 -> %0 : i32, !llvm.ptr<i32>
        %33 = func.call @_Z15step1_firstTimei(%32) : (i32) -> i8
        %34 = arith.cmpi ne, %33, %c0_i8 : i8
        scf.if %34 {
    ...
    %8 = call @_ZNKSt6vectorIiSaIiEE4sizeEv(%2) : (!llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    return %8 : i64
  }
  ...
  func.func @remote_vec_idx_int(%arg0: !llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, %arg1: i64) -> !rmem.rmref<1, !llvm.ptr<i32>> attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    %0 = rmem.llvm.getelementptr %arg0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"r::class.std::vector", (!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>) -> !llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>>
    %1 = rmem.llvm.getelementptr %0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>>) -> !llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>>
    %2 = rmem.llvm.getelementptr %1[ [0, 0]] : (!llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>>) -> !llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>>
    %3 = rmem.llvm.getelementptr %2[ [0, 0]] : (!llvm.ptr<!llvm.struct<"r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>>) -> !llvm.ptr<!rmem.rmref<1, !llvm.ptr<i32>>>
