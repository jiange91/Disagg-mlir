module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z5visitIm10MaxVisitorImmE10MinVisitorImmE11MeanVisitorImmEEvRSt6vectorIT_SaIS7_EERT0_RT1_RT2_(%arg0: !llvm.ptr<!llvm.struct<"rdur::class.std::vector", (!llvm.struct<"rdur::struct.std::_Vector_base", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<21, !llvm.ptr<i64>>, !rmem.rmref<21, !llvm.ptr<i64>>, !rmem.rmref<21, !llvm.ptr<i64>>)>)>)>)>>, %arg1: !llvm.ptr<struct<"class.MaxVisitor", packed (i64, i64, i8, array<7 x i8>)>>, %arg2: !llvm.ptr<struct<"class.MinVisitor", packed (i64, i64, i8, array<7 x i8>)>>, %arg3: !llvm.ptr<struct<"class.MeanVisitor", (i64, i64)>>) attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    ...
    scf.for %arg4 = %c0 to %9 step %c1 {
      ...
      %11 = func.call @rvec_id_index_i64(%4, %10) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
      %12 = rmem.llvm.load %11 : (!rmem.rmref<20, !llvm.ptr<i64>>) -> i64
      %13 = func.call @rvec_dur_index_i64(%arg0, %10) : (!llvm.ptr<!llvm.struct<"rdur::class.std::vector", (!llvm.struct<"rdur::struct.std::_Vector_base", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<21, !llvm.ptr<i64>>, !rmem.rmref<21, !llvm.ptr<i64>>, !rmem.rmref<21, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<21, !llvm.ptr<i64>>
      %14 = rmem.llvm.load %13 : (!rmem.rmref<21, !llvm.ptr<i64>>) -> i64
