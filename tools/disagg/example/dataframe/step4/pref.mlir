module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  rmem.llvm.global {global_type = !llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, linkage = 10 : i64, sym_name = "store_fwd_col", unnamed_addr = 0 : i64} : {
  }
  ...
  func.func @_Z41calculate_distribution_store_and_fwd_flagv() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %10 = llvm.alloca %c1_i64 x !llvm.struct<"class.anon.6", (i8)> : (i64) -> !llvm.ptr<struct<"class.anon.6", (i8)>>
    %11 = llvm.alloca %c1_i64 x !llvm.struct<"class.anon.6", (i8)> : (i64) -> !llvm.ptr<struct<"class.anon.6", (i8)>>
    ...
    %13 = llvm.alloca %c1_i64 x !llvm.struct<"class.anon", (i8)> : (i64) -> !llvm.ptr<struct<"class.anon", (i8)>>
    %14 = llvm.alloca %c1_i64 x !llvm.struct<"class.anon", (i8)> : (i64) -> !llvm.ptr<struct<"class.anon", (i8)>>
    %15 = llvm.mlir.addressof @str1 : !llvm.ptr<array<45 x i8>>
    %16 = llvm.getelementptr %15[0, 0] : (!llvm.ptr<array<45 x i8>>) -> !llvm.ptr<i8>
    %17 = llvm.call @printf(%16) : (!llvm.ptr<i8>) -> i32
    %18 = llvm.load %14 : !llvm.ptr<struct<"class.anon", (i8)>>
    llvm.store %18, %13 : !llvm.ptr<struct<"class.anon", (i8)>>
    ...
    call @_Z19get_vid_by_storefwdIZ41calculate_distribution_store_and_fwd_flagvE3$_0iEvRT_RSt6vectorIT0_SaIS4_EE(%13, %12) : (!llvm.ptr<struct<"class.anon", (i8)>>, !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> ()
    %19 = llvm.mlir.addressof @str2 : !llvm.ptr<array<4 x i8>>
    ...
    %28 = llvm.load %11 : !llvm.ptr<struct<"class.anon.6", (i8)>>
    llvm.store %28, %10 : !llvm.ptr<struct<"class.anon.6", (i8)>>
    ...
    call @_Z19get_vid_by_storefwdIZ41calculate_distribution_store_and_fwd_flagvE3$_1iEvRT_RSt6vectorIT0_SaIS4_EE(%10, %9) : (!llvm.ptr<struct<"class.anon.6", (i8)>>, !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> ()
    ...
    %31 = llvm.mlir.addressof @str3 : !llvm.ptr<array<2 x i8>>
    ...
    %38 = llvm.mlir.addressof @str4 : !llvm.ptr<array<5 x i8>>
  ...
  func.func private @_Z19get_vid_by_storefwdIZ41calculate_distribution_store_and_fwd_flagvE3$_0iEvRT_RSt6vectorIT0_SaIS4_EE(%arg0: !llvm.ptr<struct<"class.anon", (i8)>>, %arg1: !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    %6 = rmem.llvm.addressof @index_col : <!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>>
    %7 = rmem.llvm.load %6 : (!llvm.ptr<!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>>) -> !llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>
    %8 = rmem.llvm.addressof @store_fwd_col : <!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>>
    %9 = rmem.llvm.load %8 : (!llvm.ptr<!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>>) -> !llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>
    ...
    %12 = call @_ZNKSt6vectorIcSaIcEE4sizeEv(%9) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>) -> i64
    ...
    scf.for %arg2 = %c0 to %c8 step %c1 {
      ...
      %22 = func.call @_ZNKSt6vectorIcSaIcEEixEm(%9, %21) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
      %23 = rmem.request 9, %22 : (!rmem.rmref<9, !llvm.ptr<i8>>) -> i32
    ...
    scf.for %arg2 = %c0 to %c8 step %c1 {
      ...
      %20 = arith.index_cast %arg2 : index to i32
      %21 = arith.index_cast %19 : index to i64
      %22 = func.call @_ZNKSt6vectorImSaImEEixEm(%7, %21) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
      %23 = rmem.request 20, %22 : (!rmem.rmref<20, !llvm.ptr<i64>>) -> i32
      %24 = arith.extsi %20 : i32 to i64
    ...
    scf.for %arg2 = %c0 to %18 step %c1 {
      ...
      scf.if %21 {
        ...
        %48 = func.call @_ZNKSt6vectorIcSaIcEEixEm(%9, %47) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
        %49 = rmem.request 9, %48 : (!rmem.rmref<9, !llvm.ptr<i8>>) -> i32
        ...
        %57 = func.call @_ZNKSt6vectorIiSaIiEEixEm(%11, %56) : (!llvm.ptr<!llvm.struct<"rvid::class.std::vector", (!llvm.struct<"rvid::struct.std::_Vector_base", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
        %58 = rmem.request 1, %57 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
        ...
        %66 = func.call @_ZNKSt6vectorImSaImEEixEm(%7, %65) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
        %67 = rmem.request 20, %66 : (!rmem.rmref<20, !llvm.ptr<i64>>) -> i32
      ...
      %24 = func.call @_ZNKSt6vectorIcSaIcEEixEm(%9, %23) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
      %25 = arith.remsi %19, %c9_i64 : i64
      %26 = llvm.getelementptr %15[%25] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
      %27 = llvm.load %26 : !llvm.ptr<i32>
      %28 = rmem.paddr 9, %27, %24 : (i32, !rmem.rmref<9, !llvm.ptr<i8>>) -> !llvm.ptr<i8>
      %29 = func.call @_ZNKSt6vectorIiSaIiEEixEm(%11, %23) : (!llvm.ptr<!llvm.struct<"rvid::class.std::vector", (!llvm.struct<"rvid::struct.std::_Vector_base", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %30 = llvm.getelementptr %16[%25] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
      %31 = llvm.load %30 : !llvm.ptr<i32>
      %32 = rmem.paddr 1, %31, %29 : (i32, !rmem.rmref<1, !llvm.ptr<i32>>) -> !llvm.ptr<i32>
      %33 = func.call @_ZNKSt6vectorImSaImEEixEm(%7, %23) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
      %34 = llvm.getelementptr %17[%25] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
      %35 = llvm.load %34 : !llvm.ptr<i32>
      %36 = rmem.paddr 20, %35, %33 : (i32, !rmem.rmref<20, !llvm.ptr<i64>>) -> !llvm.ptr<i64>
      rmem.poll 20, %35 : (i32) -> ()
      ...
      scf.for %arg3 = %c0 to %42 step %c1 {
        ...
        %53 = func.call @_ZNKSt6vectorImSaImEEixEm(%7, %52) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
        %54 = rmem.llvm.load %51 : (!rmem.rmref<0, !llvm.ptr<i64>>) -> i64
        rmem.llvm.store %54 -> %4 : i64, !llvm.ptr<i64>
        %55 = func.call @_ZNKSt6vectorIcSaIcEEixEm(%9, %52) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
        %56 = rmem.llvm.load %47 : (!rmem.rmref<0, !llvm.ptr<i8>>) -> i8
        rmem.llvm.store %56 -> %2 : i8, !llvm.ptr<i8>
        %57 = func.call @_ZNKSt6vectorIiSaIiEEixEm(%11, %52) : (!llvm.ptr<!llvm.struct<"rvid::class.std::vector", (!llvm.struct<"rvid::struct.std::_Vector_base", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
        %58 = rmem.llvm.load %49 : (!rmem.rmref<0, !llvm.ptr<i32>>) -> i32
        rmem.llvm.store %58 -> %0 : i32, !llvm.ptr<i32>
        %59 = func.call @_ZZ41calculate_distribution_store_and_fwd_flagvENK3$_0clERKmRKc(%arg0, %4, %2) : (!llvm.ptr<struct<"class.anon", (i8)>>, !llvm.ptr<i64>, !llvm.ptr<i8>) -> i8
  ...
  func.func private @_Z19get_vid_by_storefwdIZ41calculate_distribution_store_and_fwd_flagvE3$_1iEvRT_RSt6vectorIT0_SaIS4_EE(%arg0: !llvm.ptr<struct<"class.anon.6", (i8)>>, %arg1: !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %c9_i64 = arith.constant 9 : i64
    %c8_i64 = arith.constant 8 : i64
    %c524288 = arith.constant 524288 : index
    %c1 = arith.constant 1 : index
    ...
    scf.for %arg2 = %c0 to %18 step %c1 {
      ...
      scf.for %arg3 = %c0 to %42 step %c1 {
        ...
        %58 = rmem.llvm.load %49 : (!rmem.rmref<0, !llvm.ptr<i32>>) -> i32
        rmem.llvm.store %58 -> %0 : i32, !llvm.ptr<i32>
        %59 = func.call @_ZZ41calculate_distribution_store_and_fwd_flagvENK3$_1clERKmRKc(%arg0, %4, %2) : (!llvm.ptr<struct<"class.anon.6", (i8)>>, !llvm.ptr<i64>, !llvm.ptr<i8>) -> i8
        %60 = arith.cmpi ne, %59, %c0_i8 : i8
        scf.if %60 {
          func.call @_ZNSt6vectorIiSaIiEE9push_backERKi(%arg1, %0) : (!llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>, !llvm.ptr<i32>) -> ()
        }
  ...
  func.func @_ZNKSt6vectorIcSaIcEE4sizeEv(%arg0: !llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>) -> i64 attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    %0 = rmem.llvm.getelementptr %arg0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>>
    %1 = rmem.llvm.getelementptr %0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>>
    %2 = rmem.llvm.getelementptr %1[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>>
    %3 = rmem.llvm.getelementptr %2[ [0, 1]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>>) -> !llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>
    %4 = rmem.llvm.load %3 : (!llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>) -> !rmem.rmref<9, !llvm.ptr<i8>>
    %5 = rmem.llvm.getelementptr %2[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>>) -> !llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>
    %6 = rmem.llvm.load %5 : (!llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>) -> !rmem.rmref<9, !llvm.ptr<i8>>
    %7 = rmem.llvm.ptr2int %4 : (!rmem.rmref<9, !llvm.ptr<i8>>) -> i64
    %8 = rmem.llvm.ptr2int %6 : (!rmem.rmref<9, !llvm.ptr<i8>>) -> i64
    %9 = arith.subi %7, %8 : i64
    return %9 : i64
  }
  ...
  func.func @_ZNKSt6vectorImSaImEEixEm(%arg0: !llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, %arg1: i64) -> !rmem.rmref<20, !llvm.ptr<i64>> attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
  ...
  func.func @_ZNKSt6vectorIcSaIcEEixEm(%arg0: !llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, %arg1: i64) -> !rmem.rmref<9, !llvm.ptr<i8>> attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    %0 = rmem.llvm.getelementptr %arg0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>>
    %1 = rmem.llvm.getelementptr %0[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>>
    %2 = rmem.llvm.getelementptr %1[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>>) -> !llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>>
    %3 = rmem.llvm.getelementptr %2[ [0, 0]] : (!llvm.ptr<!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>>) -> !llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>
    %4 = rmem.llvm.load %3 : (!llvm.ptr<!rmem.rmref<9, !llvm.ptr<i8>>>) -> !rmem.rmref<9, !llvm.ptr<i8>>
    %5 = rmem.llvm.getelementptr %4[%arg1 []] : (!rmem.rmref<9, !llvm.ptr<i8>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
    return %5 : !rmem.rmref<9, !llvm.ptr<i8>>
  }
  func.func @_ZNKSt6vectorIiSaIiEEixEm(%arg0: !llvm.ptr<!llvm.struct<"rvid::class.std::vector", (!llvm.struct<"rvid::struct.std::_Vector_base", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, %arg1: i64) -> !rmem.rmref<1, !llvm.ptr<i32>> attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
  ...
  func.func private @_ZZ41calculate_distribution_store_and_fwd_flagvENK3$_0clERKmRKc(%arg0: !llvm.ptr<struct<"class.anon", (i8)>>, %arg1: !llvm.ptr<i64>, %arg2: !llvm.ptr<i8>) -> i8 attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func.func private @_ZZ41calculate_distribution_store_and_fwd_flagvENK3$_1clERKmRKc(%arg0: !llvm.ptr<struct<"class.anon.6", (i8)>>, %arg1: !llvm.ptr<i64>, %arg2: !llvm.ptr<i8>) -> i8 attributes {llvm.linkage = #llvm.linkage<internal>} {
