module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func private @_Z19get_vid_by_storefwdIZ41calculate_distribution_store_and_fwd_flagvE3$_0iEvRT_RSt6vectorIT0_SaIS4_EE(%arg0: !llvm.ptr<struct<"class.anon", (i8)>>, %arg1: !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg2 = %c0 to %13 step %c1 {
      ...
      %15 = func.call @_ZNKSt6vectorImSaImEEixEm(%7, %14) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>, !rmem.rmref<20, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<20, !llvm.ptr<i64>>
      %16 = rmem.llvm.load %15 : (!rmem.rmref<20, !llvm.ptr<i64>>) -> i64
      rmem.llvm.store %16 -> %4 : i64, !llvm.ptr<i64>
      %17 = func.call @_ZNKSt6vectorIcSaIcEEixEm(%9, %14) : (!llvm.ptr<!llvm.struct<"rfwd::class.std::vector.8", (!llvm.struct<"rfwd::struct.std::_Vector_base.9", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl", (!llvm.struct<"rfwd::struct.std::_Vector_base<char, std::allocator<char>>::_Vector_impl_data", (!rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>, !rmem.rmref<9, !llvm.ptr<i8>>)>)>)>)>>, i64) -> !rmem.rmref<9, !llvm.ptr<i8>>
      %18 = rmem.llvm.load %17 : (!rmem.rmref<9, !llvm.ptr<i8>>) -> i8
      rmem.llvm.store %18 -> %2 : i8, !llvm.ptr<i8>
      %19 = func.call @_ZNKSt6vectorIiSaIiEEixEm(%11, %14) : (!llvm.ptr<!llvm.struct<"rvid::class.std::vector", (!llvm.struct<"rvid::struct.std::_Vector_base", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (!llvm.struct<"rvid::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (!rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>, !rmem.rmref<1, !llvm.ptr<i32>>)>)>)>)>>, i64) -> !rmem.rmref<1, !llvm.ptr<i32>>
      %20 = rmem.llvm.load %19 : (!rmem.rmref<1, !llvm.ptr<i32>>) -> i32
