module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @_Z29analyze_trip_durations_of_dayIsEvPKc(%arg0: !llvm.ptr<i8>) attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    ...
    scf.for %arg1 = %c0 to %18 step %c1 {
      ...
      %20 = func.call @ridx_index_i64(%12, %19) : (!llvm.ptr<!llvm.struct<"rid::class.std::vector.1", (!llvm.struct<"rid::struct.std::_Vector_base.2", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rid::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<10, !llvm.ptr<i64>>, !rmem.rmref<10, !llvm.ptr<i64>>, !rmem.rmref<10, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<10, !llvm.ptr<i64>>
      %21 = rmem.llvm.load %20 : (!rmem.rmref<10, !llvm.ptr<i64>>) -> i64
      rmem.llvm.store %21 -> %4 : i64, !llvm.ptr<i64>
      %22 = func.call @rday_index_i16(%14, %19) : (!llvm.ptr<!llvm.struct<"rday::class.std::vector.1", (!llvm.struct<"rday::struct.std::_Vector_base.2", (!llvm.struct<"rday::struct.std::_Vector_base<short, std::allocator<short>>::_Vector_impl", (!llvm.struct<"rday::struct.std::_Vector_base<short, std::allocator<short>>::_Vector_impl_data", (!rmem.rmref<13, !llvm.ptr<i16>>, !rmem.rmref<13, !llvm.ptr<i16>>, !rmem.rmref<13, !llvm.ptr<i16>>)>)>)>)>>, i64) -> !rmem.rmref<13, !llvm.ptr<i16>>
      %23 = rmem.llvm.load %22 : (!rmem.rmref<13, !llvm.ptr<i16>>) -> i16
      rmem.llvm.store %23 -> %2 : i16, !llvm.ptr<i16>
      %24 = func.call @rdur_index_i64(%16, %19) : (!llvm.ptr<!llvm.struct<"rdur::class.std::vector", (!llvm.struct<"rdur::struct.std::_Vector_base", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<11, !llvm.ptr<i64>>, !rmem.rmref<11, !llvm.ptr<i64>>, !rmem.rmref<11, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<11, !llvm.ptr<i64>>
  ...
  func.func @_Z31analyze_trip_durations_of_monthIsEvPKc(%arg0: !llvm.ptr<i8>) attributes {llvm.linkage = #llvm.linkage<linkonce_odr>} {
    ...
    scf.for %arg1 = %c0 to %18 step %c1 {
      ...
      %21 = rmem.llvm.load %20 : (!rmem.rmref<10, !llvm.ptr<i64>>) -> i64
      rmem.llvm.store %21 -> %4 : i64, !llvm.ptr<i64>
      %22 = func.call @rmon_index_i16(%14, %19) : (!llvm.ptr<!llvm.struct<"rmon::class.std::vector.1", (!llvm.struct<"rmon::struct.std::_Vector_base.2", (!llvm.struct<"rmon::struct.std::_Vector_base<short, std::allocator<short>>::_Vector_impl", (!llvm.struct<"rmon::struct.std::_Vector_base<short, std::allocator<short>>::_Vector_impl_data", (!rmem.rmref<14, !llvm.ptr<i16>>, !rmem.rmref<14, !llvm.ptr<i16>>, !rmem.rmref<14, !llvm.ptr<i16>>)>)>)>)>>, i64) -> !rmem.rmref<14, !llvm.ptr<i16>>
      %23 = rmem.llvm.load %22 : (!rmem.rmref<14, !llvm.ptr<i16>>) -> i16
      rmem.llvm.store %23 -> %2 : i16, !llvm.ptr<i16>
      %24 = func.call @rdur_index_i64(%16, %19) : (!llvm.ptr<!llvm.struct<"rdur::class.std::vector", (!llvm.struct<"rdur::struct.std::_Vector_base", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl", (!llvm.struct<"rdur::struct.std::_Vector_base<unsigned long, std::allocator<unsigned long>>::_Vector_impl_data", (!rmem.rmref<11, !llvm.ptr<i64>>, !rmem.rmref<11, !llvm.ptr<i64>>, !rmem.rmref<11, !llvm.ptr<i64>>)>)>)>)>>, i64) -> !rmem.rmref<11, !llvm.ptr<i64>>
      %25 = rmem.llvm.load %24 : (!rmem.rmref<11, !llvm.ptr<i64>>) -> i64
      rmem.llvm.store %25 -> %0 : i64, !llvm.ptr<i64>
