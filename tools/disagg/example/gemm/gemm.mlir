...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<64512x512xf32>, %arg1: memref<512x1024xf32>) -> memref<64512x1024xf32> attributes {
    input_names = ["X1", "X2"], 
    ...
    "operand_types" = [
      ...
      !rmem.rmref<1, memref<512x1024xf32>>
    ], 
    "rel_types" = [!rmem.rmref<1, memref<64512x1024xf32>>]} {
    ...
    affine.for %arg2 = 0 to 64512 step 4 {
      ...
      affine.for %arg3 = 0 to 1024 step 8 {
        affine.for %arg4 = 0 to 512 step 8 {
          ...
          %0 = vector.load %alloc[%arg2, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          affine.store %0, %alloca[0] : memref<4xvector<8xf32>>
          %1 = arith.addi %arg2, %c1 : index
          %2 = vector.load %alloc[%1, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          affine.store %2, %alloca[1] : memref<4xvector<8xf32>>
          %3 = arith.addi %arg2, %c2 : index
          %4 = vector.load %alloc[%3, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          affine.store %4, %alloca[2] : memref<4xvector<8xf32>>
          %5 = arith.addi %arg2, %c3 : index
          %6 = vector.load %alloc[%5, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          affine.store %6, %alloca[3] : memref<4xvector<8xf32>>
          affine.for %arg5 = 0 to 8 step 4 {
            %11 = arith.addi %arg5, %arg4 : index
            %12 = memref.load %arg0[%arg2, %11] {"remote_check_use" = 1} : memref<64512x512xf32>
            %13 = vector.broadcast %12 : f32 to vector<8xf32>
            %14 = vector.load %arg1[%11, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %19 = memref.load %arg0[%arg2, %18] {"remote_check_use" = 1} : memref<64512x512xf32>
            %20 = vector.broadcast %19 : f32 to vector<8xf32>
            %21 = vector.load %arg1[%18, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %26 = memref.load %arg0[%arg2, %25] {"remote_check_use" = 1} : memref<64512x512xf32>
            %27 = vector.broadcast %26 : f32 to vector<8xf32>
            %28 = vector.load %arg1[%25, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %33 = memref.load %arg0[%arg2, %32] {"remote_check_use" = 1} : memref<64512x512xf32>
            %34 = vector.broadcast %33 : f32 to vector<8xf32>
            %35 = vector.load %arg1[%32, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %38 = memref.load %arg0[%1, %11] {"remote_check_use" = 1} : memref<64512x512xf32>
            %39 = vector.broadcast %38 : f32 to vector<8xf32>
            %40 = vector.load %arg1[%11, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %43 = memref.load %arg0[%1, %18] {"remote_check_use" = 1} : memref<64512x512xf32>
            %44 = vector.broadcast %43 : f32 to vector<8xf32>
            %45 = vector.load %arg1[%18, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %48 = memref.load %arg0[%1, %25] {"remote_check_use" = 1} : memref<64512x512xf32>
            %49 = vector.broadcast %48 : f32 to vector<8xf32>
            %50 = vector.load %arg1[%25, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %53 = memref.load %arg0[%1, %32] {"remote_check_use" = 1} : memref<64512x512xf32>
            %54 = vector.broadcast %53 : f32 to vector<8xf32>
            %55 = vector.load %arg1[%32, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %58 = memref.load %arg0[%3, %11] {"remote_check_use" = 1} : memref<64512x512xf32>
            %59 = vector.broadcast %58 : f32 to vector<8xf32>
            %60 = vector.load %arg1[%11, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %63 = memref.load %arg0[%3, %18] {"remote_check_use" = 1} : memref<64512x512xf32>
            %64 = vector.broadcast %63 : f32 to vector<8xf32>
            %65 = vector.load %arg1[%18, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %68 = memref.load %arg0[%3, %25] {"remote_check_use" = 1} : memref<64512x512xf32>
            %69 = vector.broadcast %68 : f32 to vector<8xf32>
            %70 = vector.load %arg1[%25, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %73 = memref.load %arg0[%3, %32] {"remote_check_use" = 1} : memref<64512x512xf32>
            %74 = vector.broadcast %73 : f32 to vector<8xf32>
            %75 = vector.load %arg1[%32, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %78 = memref.load %arg0[%5, %11] {"remote_check_use" = 1} : memref<64512x512xf32>
            %79 = vector.broadcast %78 : f32 to vector<8xf32>
            %80 = vector.load %arg1[%11, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %83 = memref.load %arg0[%5, %18] {"remote_check_use" = 1} : memref<64512x512xf32>
            %84 = vector.broadcast %83 : f32 to vector<8xf32>
            %85 = vector.load %arg1[%18, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %88 = memref.load %arg0[%5, %25] {"remote_check_use" = 1} : memref<64512x512xf32>
            %89 = vector.broadcast %88 : f32 to vector<8xf32>
            %90 = vector.load %arg1[%25, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
            ...
            %93 = memref.load %arg0[%5, %32] {"remote_check_use" = 1} : memref<64512x512xf32>
            %94 = vector.broadcast %93 : f32 to vector<8xf32>
            %95 = vector.load %arg1[%32, %arg3] {"remote_check_use" = 1} : memref<512x1024xf32>, vector<8xf32>
          ...
          vector.store %7, %alloc[%arg2, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          %8 = affine.load %alloca[1] : memref<4xvector<8xf32>>
          vector.store %8, %alloc[%1, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          %9 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          vector.store %9, %alloc[%3, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
          %10 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          vector.store %10, %alloc[%5, %arg3] {"remote_check_use" = 1} : memref<64512x1024xf32>, vector<8xf32>
        }
      }
    }
    return {"remote_check_use" = 1} %alloc : memref<64512x1024xf32>
  }
}
