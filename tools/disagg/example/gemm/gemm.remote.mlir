...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: !rmem.rmref<1, memref<64512x512xf32>>, %arg1: !rmem.rmref<1, memref<512x1024xf32>>) -> !rmem.rmref<1, memref<64512x1024xf32>> attributes {input_names = ["X1", "X2"], llvm.emit_c_interface, output_names = ["Y"]} {
    ...
    // %r0 = !rmem.to_addr (%0) -> memref<64512x1024xf32>
    // %rp0 = memref.extract_aligned_pointer_as_index %r0 : memref<64512x1024xf32> -> Index
    // %1 = arith.index_cast %0 : index to i64
    // %pq = !rmem.prefetch(%0)[%arg2] (map = #pmap) -> memref<2x1024xf32>
    // %p2 = !rmem.prefetch(%1)[%arg2] (map = #pmap) -> memref<2x1024xf32>
    // affine.for %arg2 = 0 to 64512 step 1 
    //   iter_args(%buf = %prelogue) -> (memref<2x1024xf32>)
    //   %stable = !rmem.prefetch(%1)[%arg2] (map = #pmap1) -> memref<1x1024xf32>
    //   sync(%arg2)
    //   affine.for %arg2-2 = 0 to 1 step 1 {
    //     affine.for %arg3 = 0 to 1024 {
    //       rmem.affine.store %cst -> %buf[%arg2-2, %arg3] {map = #map} : f32, memref<1x1024xf32>>, index, index
    //     }
    //   }
    //   affine.yield %stable : memref<1x1024xf32>
    // }
    ...
    } {"pf_target" = 1, "nahead" = [2], "access_mem" = [#amap], "access_size" = [1024], "batch" = 2}

    affine.for %arg2 = 0 to 64512 step 4 {
      // access_mem: %0[arg2->arg2+3, 0->1024]
      // access_mem: %arg0[arg2->arg2+3, 0->512]
      // access_mem: %arg1[0->512, 0->1024]
      affine.for %arg3 = 0 to 1024 step 8 {
        // access_mem: %0[arg2,   arg3->arg3+8]
        // access_mem: %0[arg2+1, arg3->arg3+8]
        // access_mem: %0[arg2+2, arg3->arg3+8]
        // access_mem: %0[arg2+3, arg3->arg3+8]

        // access_mem: %arg0[arg2 -> arg2 + 3, 0->512]

        // access_mem: %arg1[0,   arg3->arg3+8]
        // ...
        // access_mem: %arg1[512, arg3->arg3+8]
