...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu",
  ...
  // "t" = [rbase,  l_ofst,    r_ofst, SizeInEle, eleType, bSize,  nBlock, type],
    ...
    "t2" = ["ref2", 269492224, 0,      33030144,  f32,     4096,   8064,   1]}
} {
  ...
  access_mem_catcher = [["ref0", 0], ["ref1", 1]] 
    ...
    %out0 = memref.alloc() {alignment = 16 : i64} : memref<64512x512xf32>
    ...
    affine.for %arg2 = 0 to 64512 step 4 {
      affine.for %arg3 = 0 to 512 step 8 {
        affine.for %arg4 = 0 to 512 step 8 {
          ...
          %1 = rmem.vec.load %0[%arg2, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %1, %alloca[0] : memref<4xvector<8xf32>>
          %2 = arith.addi %arg2, %c1 : index
          %3 = rmem.vec.load %0[%2, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %3, %alloca[1] : memref<4xvector<8xf32>>
          %4 = arith.addi %arg2, %c2 : index
          %5 = rmem.vec.load %0[%4, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %5, %alloca[2] : memref<4xvector<8xf32>>
          %6 = arith.addi %arg2, %c3 : index
          %7 = rmem.vec.load %0[%6, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          ...
          affine.for %arg5 = 0 to 8 step 4 {
            ...
            %15 = rmem.vec.load %arg1[%12, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %22 = rmem.vec.load %arg1[%19, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %29 = rmem.vec.load %arg1[%26, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %36 = rmem.vec.load %arg1[%33, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %41 = rmem.vec.load %arg1[%12, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %46 = rmem.vec.load %arg1[%19, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %51 = rmem.vec.load %arg1[%26, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %56 = rmem.vec.load %arg1[%33, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %61 = rmem.vec.load %arg1[%12, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %66 = rmem.vec.load %arg1[%19, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %71 = rmem.vec.load %arg1[%26, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %76 = rmem.vec.load %arg1[%33, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %81 = rmem.vec.load %arg1[%12, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %86 = rmem.vec.load %arg1[%19, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %91 = rmem.vec.load %arg1[%26, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
            ...
            %96 = rmem.vec.load %arg1[%33, %arg3] : !rmem.rmref<1, memref<512x512xf32>>, vector<8xf32>
          ...
          // rmem.vec.store %8, %0[%arg2, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          // %9 = affine.load %alloca[1] : memref<4xvector<8xf32>>
          // rmem.vec.store %9, %0[%2, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          // %10 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          // rmem.vec.store %10, %0[%4, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          // %11 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          // rmem.vec.store %11, %0[%6, %arg3] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          %8 = affine.load %alloca[0] : memref<4xvector<8xf32>>
          vector.store %8, %out0[%arg2, %arg3] : memref<64512x512xf32>, vector<8xf32>
          %9 = affine.load %alloca[1] : memref<4xvector<8xf32>>
          vector.store %9, %out0[%2, %arg3] : memref<64512x512xf32>, vector<8xf32>
          %10 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          vector.store %10, %out0[%4, %arg3] : memref<64512x512xf32>, vector<8xf32>
          %11 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          vector.store %11, %out0[%6, %arg3] : memref<64512x512xf32>, vector<8xf32>
        }
      }
