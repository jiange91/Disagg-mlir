...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  access_mem_catcher = [["ref0", 0], ["ref1", 1]]} {
    ...
    %0 = rmem.alloc_memref(2, ) {alignment = 16 : i64, access_mem_catcher = [["ref2", 0]]} : <1, memref<64512x1024xf32>>
    %out0 = memref.alloc() {alignment = 16 : i64} : memref<64512x1024xf32>
    ...
    affine.for %arg2 = 0 to 64512 step 4 {
      ...
      // access_mem: %arg0[arg2->arg2+4, 0->512]
      ...
      affine.for %arg3 = 0 to 1024 step 8 {
        affine.for %arg4 = 0 to 512 step 8 {
          ...
          vector.store %9, %out0[%2, %arg3] : memref<64512x1024xf32>, vector<8xf32>
          %10 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          vector.store %10, %out0[%4, %arg3] : memref<64512x1024xf32>, vector<8xf32>
          %11 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          vector.store %11, %out0[%6, %arg3] : memref<64512x1024xf32>, vector<8xf32>
        }
      }
