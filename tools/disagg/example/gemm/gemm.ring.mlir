...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", rmem.templates = {t0 = ["ref0", 8192, 0, 33030144, f32, 4096, 8064, 1], t1 = ["ref1", 268443648, 0, 524288, f32, 524288, 1, 1], t2 = ["ref2", 269492224, 0, 66060288, f32, 8192, 8064, 1]}} {
  func.func @main_graph(%arg0: !rmem.rmref<1, memref<64512x512xf32>>, %arg1: !rmem.rmref<1, memref<512x1024xf32>>) -> !rmem.rmref<1, memref<64512x1024xf32>> attributes {access_mem_catcher = [["ref0", 0], ["ref1", 1]], input_names = ["X1", "X2"], llvm.emit_c_interface, output_names = ["Y"]} {
    ...
    %3 = rmem.slot %c0 {mem = "t2"} : (index) -> memref<8x1024xf32>
    %4 = rmem.slot %c1 {mem = "t2"} : (index) -> memref<8x1024xf32>
    %5:4 = affine.for %arg2 = 0 to 64512 step 8 iter_args(%arg3 = %c2, %arg4 = %c0, %arg5 = %3, %arg6 = %4) -> (index, index, memref<8x1024xf32>, memref<8x1024xf32>) {
      %14 = arith.addi %arg3, %c1 : index
      %15 = arith.addi %arg4, %c1 : index
      %16 = rmem.slot %arg3 {mem = "t2"} : (index) -> memref<8x1024xf32>
      affine.for %arg7 = 0 to 8 {
        affine.for %arg8 = 0 to 1024 {
          affine.store %cst, %arg5[%arg7, %arg8] : memref<8x1024xf32>
        }
      }
      %17 = rmem.wrid : index
      %18 = rmem.rdma %arg4, %0[%arg2] %c8192 0 %17 {map = #map, mem = "t2"} : (index, !rmem.rmref<1, memref<64512x1024xf32>>, index, index, index) -> memref<8x1024xf32>
      rmem.sync %2 -> %17 : <i64>, index
      affine.yield %14, %15, %arg6, %16 : index, index, memref<8x1024xf32>, memref<8x1024xf32>
    }
    ...
    %8 = rmem.wrid : index
    %9 = rmem.rdma %c0, %arg1[%c0] %c524288 4 %8 {map = #map1, mem = "t1"} : (index, !rmem.rmref<1, memref<512x1024xf32>>, index, index, index) -> memref<524288xf32>
    %10 = rmem.rdma %c0, %arg0[%c0] %c4096 4 %c0 {map = #map2, mem = "t0"} : (index, !rmem.rmref<1, memref<64512x512xf32>>, index, index, index) -> memref<2x2048xf32>
    %11 = rmem.wrid : index
    %12 = rmem.rdma %c0, %0[%c0] %c8192 4 %11 {map = #map, mem = "t2"} : (index, !rmem.rmref<1, memref<64512x1024xf32>>, index, index, index) -> memref<2x4096xf32>
    rmem.sync %6 -> %8 : <i64>, index
    %13:6 = affine.for %arg2 = 0 to 64512 step 8 iter_args(%arg3 = %c1, %arg4 = %c0, %arg5 = %9, %arg6 = %10, %arg7 = %12, %arg8 = %11) -> (index, index, memref<524288xf32>, memref<2x2048xf32>, memref<2x4096xf32>, index) {
      %14 = arith.addi %arg3, %c1 : index
      %15 = arith.addi %arg4, %c1 : index
      %16 = arith.addi %arg2, %c8 : index
      %17 = rmem.rdma %c0, %arg0[%16] %c4096 4 %c0 {map = #map2, mem = "t0"} : (index, !rmem.rmref<1, memref<64512x512xf32>>, index, index, index) -> memref<2x2048xf32>
      %18 = rmem.wrid : index
      %19 = rmem.rdma %c0, %0[%16] %c8192 4 %18 {map = #map, mem = "t2"} : (index, !rmem.rmref<1, memref<64512x1024xf32>>, index, index, index) -> memref<2x4096xf32>
      rmem.sync %6 -> %arg8 : <i64>, index
      affine.for %arg9 = 0 to 2 {
        %20 = arith.muli %arg9, %c4 : index
        %21 = arith.addi %arg2, %20 : index
        affine.for %arg10 = 0 to 1024 step 8 {
          affine.for %arg11 = 0 to 512 step 8 {
            %alloca = memref.alloca() {alignment = 64 : i64} : memref<4xvector<8xf32>>
            %22 = vector.load %arg7[%arg9, %arg10] : memref<2x4096xf32>, vector<8xf32>
            affine.store %22, %alloca[0] : memref<4xvector<8xf32>>
            %23 = arith.addi %21, %c1 : index
            %24 = affine.apply #map3(%arg10)
            %25 = vector.load %arg7[%arg9, %24] : memref<2x4096xf32>, vector<8xf32>
            affine.store %25, %alloca[1] : memref<4xvector<8xf32>>
            %26 = arith.addi %21, %c2 : index
            %27 = affine.apply #map4(%arg10)
            %28 = vector.load %arg7[%arg9, %27] : memref<2x4096xf32>, vector<8xf32>
            affine.store %28, %alloca[2] : memref<4xvector<8xf32>>
            %29 = arith.addi %21, %c3 : index
            %30 = affine.apply #map5(%arg10)
            %31 = vector.load %arg7[%arg9, %30] : memref<2x4096xf32>, vector<8xf32>
            affine.store %31, %alloca[3] : memref<4xvector<8xf32>>
            affine.for %arg12 = 0 to 8 step 4 {
              %36 = affine.apply #map6(%arg11, %arg12)
              %37 = memref.load %arg6[%arg9, %36] : memref<2x2048xf32>
              %38 = vector.broadcast %37 : f32 to vector<8xf32>
              %39 = affine.apply #map7(%arg10, %arg11, %arg12)
              %40 = vector.load %arg5[%39] : memref<524288xf32>, vector<8xf32>
              ...
              %43 = affine.apply #map8(%arg11, %arg12)
              %44 = memref.load %arg6[%arg9, %43] : memref<2x2048xf32>
              %45 = vector.broadcast %44 : f32 to vector<8xf32>
              %46 = affine.apply #map9(%arg10, %arg11, %arg12)
              %47 = vector.load %arg5[%46] : memref<524288xf32>, vector<8xf32>
              ...
              %50 = affine.apply #map10(%arg11, %arg12)
              %51 = memref.load %arg6[%arg9, %50] : memref<2x2048xf32>
              %52 = vector.broadcast %51 : f32 to vector<8xf32>
              %53 = affine.apply #map11(%arg10, %arg11, %arg12)
              %54 = vector.load %arg5[%53] : memref<524288xf32>, vector<8xf32>
              ...
              %57 = affine.apply #map12(%arg11, %arg12)
              %58 = memref.load %arg6[%arg9, %57] : memref<2x2048xf32>
              %59 = vector.broadcast %58 : f32 to vector<8xf32>
              %60 = affine.apply #map13(%arg10, %arg11, %arg12)
              %61 = vector.load %arg5[%60] : memref<524288xf32>, vector<8xf32>
            ...
            vector.store %32, %alloc[%21, %arg10] : memref<64512x1024xf32>, vector<8xf32>
            %33 = affine.load %alloca[1] : memref<4xvector<8xf32>>
            vector.store %33, %alloc[%23, %arg10] : memref<64512x1024xf32>, vector<8xf32>
            %34 = affine.load %alloca[2] : memref<4xvector<8xf32>>
            vector.store %34, %alloc[%26, %arg10] : memref<64512x1024xf32>, vector<8xf32>
            %35 = affine.load %alloca[3] : memref<4xvector<8xf32>>
            vector.store %35, %alloc[%29, %arg10] : memref<64512x1024xf32>, vector<8xf32>
          }
        }
      }
      affine.yield %14, %15, %arg5, %17, %19, %18 : index, index, memref<524288xf32>, memref<2x2048xf32>, memref<2x4096xf32>, index
    }
