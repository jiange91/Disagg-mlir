module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  llvm.mlir.global external @glob() {
    "remote_target" = 1,
    "remote_global_type" = !llvm.ptr<!rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A">>>)>>>>
    ...
    llvm.return {"remote_target"=1} %0 : !llvm.ptr<ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>>
  }
  ...
  func.func @expand(%arg0: !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>, %arg1: i32) -> !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>> attributes {llvm.linkage = #llvm.linkage<external>,
    "remote_target" = 1,
    "operand_types" = [
      !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A">>>)>>>,
      i32
    ],
    "rel_types" = [
      !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A">>>)>>> 
    ...
    %0 = llvm.call @malloc(%c16_i64) {
      "remote_target" = 1,
      "rel_types" = [!rmem.rmref<1, !llvm.ptr<i8>>]
    } : (i64) -> !llvm.ptr<i8>
    %1 = llvm.bitcast %0 {
      "remote_target" = 1,
    ...
    } : !llvm.ptr<i8> to !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>
    %2 = llvm.getelementptr %1[%c0_i32, 0] {
      "remote_target" = 1,
      "rel_types" = [!rmem.rmref<1, !llvm.ptr<struct<(i32)>>>]
    } : (!llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>, i32) -> !llvm.ptr<struct<(i32)>>
    %3 = llvm.getelementptr %2[%c0_i32, 0] {
      "remote_target" = 1,
    ...
    %5 = llvm.mlir.null {
      "remote_target" = 1,
      "rel_types" = [!rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A">>>)>>>]
    } : !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>
    llvm.store %5, %4 {"remote_target"=1} : !llvm.ptr<ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>>
    %6 = llvm.getelementptr %arg0[%c0_i32, 1] {
      "remote_target" = 1,
      "rel_types" = [!rmem.rmref<1, !llvm.ptr<!rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A", (struct<(i32)>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@polygeist@mlir@struct.A">>>)>>>>>]
    } : (!llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>, i32) -> !llvm.ptr<ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>>
    llvm.store %1, %6 {"remote_target"=1} : !llvm.ptr<ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>>
    return {"remote_target"=1} %1 : !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>
  }

  func.func @visit(%arg0: i32) attributes {llvm.linkage = #llvm.linkage<external>} {
    %c0_i32 = arith.constant 0 : i32
    %0 = llvm.mlir.addressof @glob {
      "remote_target" = 1,
    ...
    %12 = scf.while (%arg1 = %5) : (!llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>) -> !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>> {
      %13 = llvm.icmp "ne" %arg1, %9 {"remote_target"=1} : !llvm.ptr<struct<"polygeist@mlir@struct.A", (struct<(i32)>, ptr<struct<"polygeist@mlir@struct.A">>)>>
