module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  llvm.mlir.global external @arc() {
    addr_space = 0 : i32,
    remote_target = 1,
    rel_types = [!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, i32, array<23 x i32>)>>>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, array<8 x i32>)>>>]
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>, remote_target = 1} {
    ...
    %4 = llvm.mlir.addressof @arc {
      remote_target = 1,
      rel_types = [!llvm.ptr<!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, i32, array<23 x i32>)>>>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, array<8 x i32>)>>>>]
  ...
  func.func @visit(%arg0: !llvm.ptr<struct<"struct.arc", (ptr<struct<"struct.node", (ptr<struct<"struct.arc">>, i32, array<23 x i32>)>>, ptr<struct<"struct.arc">>, array<8 x i32>)>>) attributes {llvm.linkage = #llvm.linkage<external>, 
    remote_target = 1,
    operand_types = [!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, i32, array<23 x i32>)>>>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, array<8 x i32>)>>>]
  } {
    ...
    %0 = llvm.alloca %c1_i64 x !llvm.struct<"struct.node", (ptr<struct<"struct.arc", (ptr<struct<"struct.node">>, ptr<struct<"struct.arc">>, array<8 x i32>)>>, i32, array<23 x i32>)> {
      remote_target = 1,
      rel_types = [!llvm.ptr<!llvm.struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<!llvm.struct<"disagg@struct.node">>>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc">>>, array<8 x i32>)>>>, i32, array<23 x i32>)>>]
    ...
    %1 = llvm.alloca %c1_i64 x !llvm.struct<"struct.arc", (ptr<struct<"struct.node", (ptr<struct<"struct.arc">>, i32, array<23 x i32>)>>, ptr<struct<"struct.arc">>, array<8 x i32>)> {
      remote_target = 1,
      rel_types = [!llvm.ptr<struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, i32, array<23 x i32>)>>>, !rmem.rmref<1, !llvm.ptr<struct<"disagg@struct.arc">>>, array<8 x i32>)>>]
  ...
  func.func private @computation(!llvm.ptr<struct<"struct.arc", (ptr<struct<"struct.node", (ptr<struct<"struct.arc">>, i32, array<23 x i32>)>>, ptr<struct<"struct.arc">>, array<8 x i32>)>>, !llvm.ptr<struct<"struct.node", (ptr<struct<"struct.arc", (ptr<struct<"struct.node">>, ptr<struct<"struct.arc">>, array<8 x i32>)>>, i32, array<23 x i32>)>>, i32) attributes {
    ...
    remote_target = 1,
    operand_types = [!llvm.ptr<!llvm.struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<!llvm.struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc">>>, i32, array<23 x i32>)>>>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc">>>, array<8 x i32>)>>, !llvm.ptr<!llvm.struct<"disagg@struct.node", (!rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc", (!rmem.rmref<2, !llvm.ptr<!llvm.struct<"disagg@struct.node">>>, !rmem.rmref<1, !llvm.ptr<!llvm.struct<"disagg@struct.arc">>>, array<8 x i32>)>>>, i32, array<23 x i32>)>>, i32]
    }
}
