...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @_driver(%arg0: !llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>, %arg1: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg2: memref<512x512xf32>) attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg3 = %c0 to %c1_0 step %c1 {
      ...
      %3 = rmem.llvm.getelementptr %arg0[%0 []] : (!llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>, i64) -> !llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>
      %4 = rmem.llvm.load %3 : (!llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>) -> !rmem.rmref<2, memref<64512x512xf32>>
      %c0_1 = arith.constant 0 : index
      %5 = arith.cmpi eq, %c0_1, %arg3 : index
      scf.if %5 {
        func.call @run_task_0(%4, %2, %arg2) : (!rmem.rmref<2, memref<64512x512xf32>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>) -> ()
      }
    }
    return
  }
  ...
  func.func private @run_task_0(!rmem.rmref<2, memref<64512x512xf32>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>) attributes {llvm.emit_c_interface, llvm.linkage = #llvm.linkage<external>}
}
