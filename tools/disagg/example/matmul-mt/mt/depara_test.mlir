...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @_driver(%arg0: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg1: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg2: memref<512x512xf32>) attributes {llvm.emit_c_interface} {
    ...
    scf.for %arg3 = %c0 to %c2 step %c1 {
      ...
      %4 = arith.cmpi eq, %c0_0, %arg3 : index
      scf.if %4 {
        func.call @main_graph__0(%3, %2, %arg2) : (!llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>) -> ()
      }
      %c1_1 = arith.constant 1 : index
      %5 = arith.cmpi eq, %c1_1, %arg3 : index
      scf.if %5 {
        func.call @main_graph__1(%3, %2, %arg2) : (!llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>) -> ()
      }
    }
    return
  }
  func.func @main_graph__1(%arg0: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg1: !rmem.rmref<1, memref<64512x512xf32>>, %arg2: memref<512x512xf32>) attributes {input_names = ["X1", "X2"], output_names = ["Y"]} {
    %c1 = arith.constant 1 : index
    %c2 = arith.constant 2 : index
    %c3 = arith.constant 3 : index
    %cst = arith.constant 0.000000e+00 : f32
    %0 = rmem.alloc_memref(2, ) {alignment = 16 : i64} : <1, memref<64512x512xf32>>
    affine.for %arg3 = 0 to 64512 {
      affine.for %arg4 = 0 to 512 {
        rmem.affine.store %cst -> %0[%arg3, %arg4] {map = #map} : f32, !rmem.rmref<1, memref<64512x512xf32>>, index, index
      }
    }
    affine.for %arg3 = 0 to 64512 step 4 {
      affine.for %arg4 = 0 to 512 step 8 {
        affine.for %arg5 = 0 to 512 step 8 {
          ...
          %1 = rmem.vec.load %0[%arg3, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %1, %alloca[0] : memref<4xvector<8xf32>>
          %2 = arith.addi %arg3, %c1 : index
          %3 = rmem.vec.load %0[%2, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %3, %alloca[1] : memref<4xvector<8xf32>>
          %4 = arith.addi %arg3, %c2 : index
          %5 = rmem.vec.load %0[%4, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %5, %alloca[2] : memref<4xvector<8xf32>>
          %6 = arith.addi %arg3, %c3 : index
          %7 = rmem.vec.load %0[%6, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          affine.store %7, %alloca[3] : memref<4xvector<8xf32>>
          affine.for %arg6 = 0 to 8 step 4 {
            %12 = arith.addi %arg6, %arg5 : index
            %13 = rmem.memref.load %arg1[%arg3, %12] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %14 = vector.broadcast %13 : f32 to vector<8xf32>
            %15 = vector.load %arg2[%12, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %20 = rmem.memref.load %arg1[%arg3, %19] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %21 = vector.broadcast %20 : f32 to vector<8xf32>
            %22 = vector.load %arg2[%19, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %27 = rmem.memref.load %arg1[%arg3, %26] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %28 = vector.broadcast %27 : f32 to vector<8xf32>
            %29 = vector.load %arg2[%26, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %32 = affine.apply #map3(%arg6)
            %33 = arith.addi %32, %arg5 : index
            %34 = rmem.memref.load %arg1[%arg3, %33] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %35 = vector.broadcast %34 : f32 to vector<8xf32>
            %36 = vector.load %arg2[%33, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %39 = rmem.memref.load %arg1[%2, %12] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %40 = vector.broadcast %39 : f32 to vector<8xf32>
            %41 = vector.load %arg2[%12, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %44 = rmem.memref.load %arg1[%2, %19] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %45 = vector.broadcast %44 : f32 to vector<8xf32>
            %46 = vector.load %arg2[%19, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %49 = rmem.memref.load %arg1[%2, %26] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %50 = vector.broadcast %49 : f32 to vector<8xf32>
            %51 = vector.load %arg2[%26, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %54 = rmem.memref.load %arg1[%2, %33] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %55 = vector.broadcast %54 : f32 to vector<8xf32>
            %56 = vector.load %arg2[%33, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %59 = rmem.memref.load %arg1[%4, %12] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %60 = vector.broadcast %59 : f32 to vector<8xf32>
            %61 = vector.load %arg2[%12, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %64 = rmem.memref.load %arg1[%4, %19] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %65 = vector.broadcast %64 : f32 to vector<8xf32>
            %66 = vector.load %arg2[%19, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %69 = rmem.memref.load %arg1[%4, %26] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %70 = vector.broadcast %69 : f32 to vector<8xf32>
            %71 = vector.load %arg2[%26, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %74 = rmem.memref.load %arg1[%4, %33] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %75 = vector.broadcast %74 : f32 to vector<8xf32>
            %76 = vector.load %arg2[%33, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %79 = rmem.memref.load %arg1[%6, %12] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %80 = vector.broadcast %79 : f32 to vector<8xf32>
            %81 = vector.load %arg2[%12, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %84 = rmem.memref.load %arg1[%6, %19] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %85 = vector.broadcast %84 : f32 to vector<8xf32>
            %86 = vector.load %arg2[%19, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %89 = rmem.memref.load %arg1[%6, %26] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %90 = vector.broadcast %89 : f32 to vector<8xf32>
            %91 = vector.load %arg2[%26, %arg4] : memref<512x512xf32>, vector<8xf32>
            ...
            %94 = rmem.memref.load %arg1[%6, %33] : (!rmem.rmref<1, memref<64512x512xf32>>, index, index) -> f32
            %95 = vector.broadcast %94 : f32 to vector<8xf32>
            %96 = vector.load %arg2[%33, %arg4] : memref<512x512xf32>, vector<8xf32>
          ...
          rmem.vec.store %8, %0[%arg3, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          %9 = affine.load %alloca[1] : memref<4xvector<8xf32>>
          rmem.vec.store %9, %0[%2, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          %10 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          rmem.vec.store %10, %0[%4, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
          %11 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          rmem.vec.store %11, %0[%6, %arg4] : !rmem.rmref<1, memref<64512x512xf32>>, vector<8xf32>
        }
      }
    }
  ...
  func.func @main_graph__0(%arg0: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg1: !rmem.rmref<1, memref<64512x512xf32>>, %arg2: memref<512x512xf32>) attributes {input_names = ["X1", "X2"], output_names = ["Y"]} {
    %c1 = arith.constant 1 : index
    %c2 = arith.constant 2 : index
    %c3 = arith.constant 3 : index
    %cst = arith.constant 0.000000e+00 : f32
