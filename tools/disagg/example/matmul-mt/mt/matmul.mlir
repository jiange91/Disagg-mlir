...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @_driver(%alloc: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg0: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg1: memref<512x512xf32>) attributes {llvm.emit_c_interface} {
    // %A1 = memref.subview %arg0[0, 0, 0][1, 64512, 512][1, 1, 1] : memref<2x64512x512xf32> to memref<64512x512xf32>
    %A1 = rmem.llvm.load %arg0 : (!llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>) -> !rmem.rmref<1, memref<64512x512xf32>>
    rmem.llvm.store %A1 -> %alloc : !rmem.rmref<1, memref<64512x512xf32>>, !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>
    // call @main_graph(%C2, %A2, %arg1) : (memref<64512x512xf32>, memref<64512x512xf32>, memref<512x512xf32>) -> ()
    return
  }
      ...
      affine.for %arg3 = 0 to 512 step 8 {
        affine.for %arg4 = 0 to 512 step 8 {
          ...
          affine.for %arg5 = 0 to 8 step 4 {
            ...
            %12 = memref.load %arg0[%arg2, %11] : memref<64512x512xf32>
            %13 = vector.broadcast %12 : f32 to vector<8xf32>
            %14 = vector.load %arg1[%11, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %19 = memref.load %arg0[%arg2, %18] : memref<64512x512xf32>
            %20 = vector.broadcast %19 : f32 to vector<8xf32>
            %21 = vector.load %arg1[%18, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %26 = memref.load %arg0[%arg2, %25] : memref<64512x512xf32>
            %27 = vector.broadcast %26 : f32 to vector<8xf32>
            %28 = vector.load %arg1[%25, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %33 = memref.load %arg0[%arg2, %32] : memref<64512x512xf32>
            %34 = vector.broadcast %33 : f32 to vector<8xf32>
            %35 = vector.load %arg1[%32, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %38 = memref.load %arg0[%1, %11] : memref<64512x512xf32>
            %39 = vector.broadcast %38 : f32 to vector<8xf32>
            %40 = vector.load %arg1[%11, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %43 = memref.load %arg0[%1, %18] : memref<64512x512xf32>
            %44 = vector.broadcast %43 : f32 to vector<8xf32>
            %45 = vector.load %arg1[%18, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %48 = memref.load %arg0[%1, %25] : memref<64512x512xf32>
            %49 = vector.broadcast %48 : f32 to vector<8xf32>
            %50 = vector.load %arg1[%25, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %53 = memref.load %arg0[%1, %32] : memref<64512x512xf32>
            %54 = vector.broadcast %53 : f32 to vector<8xf32>
            %55 = vector.load %arg1[%32, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %58 = memref.load %arg0[%3, %11] : memref<64512x512xf32>
            %59 = vector.broadcast %58 : f32 to vector<8xf32>
            %60 = vector.load %arg1[%11, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %63 = memref.load %arg0[%3, %18] : memref<64512x512xf32>
            %64 = vector.broadcast %63 : f32 to vector<8xf32>
            %65 = vector.load %arg1[%18, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %68 = memref.load %arg0[%3, %25] : memref<64512x512xf32>
            %69 = vector.broadcast %68 : f32 to vector<8xf32>
            %70 = vector.load %arg1[%25, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %73 = memref.load %arg0[%3, %32] : memref<64512x512xf32>
            %74 = vector.broadcast %73 : f32 to vector<8xf32>
            %75 = vector.load %arg1[%32, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %78 = memref.load %arg0[%5, %11] : memref<64512x512xf32>
            %79 = vector.broadcast %78 : f32 to vector<8xf32>
            %80 = vector.load %arg1[%11, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %83 = memref.load %arg0[%5, %18] : memref<64512x512xf32>
            %84 = vector.broadcast %83 : f32 to vector<8xf32>
            %85 = vector.load %arg1[%18, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %88 = memref.load %arg0[%5, %25] : memref<64512x512xf32>
            %89 = vector.broadcast %88 : f32 to vector<8xf32>
            %90 = vector.load %arg1[%25, %arg3] : memref<512x512xf32>, vector<8xf32>
            ...
            %93 = memref.load %arg0[%5, %32] : memref<64512x512xf32>
            %94 = vector.broadcast %93 : f32 to vector<8xf32>
            %95 = vector.load %arg1[%32, %arg3] : memref<512x512xf32>, vector<8xf32>
