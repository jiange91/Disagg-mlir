...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @_driver(%out: !llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>, %arg0: !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, %arg1: memref<512x512xf32>) attributes {llvm.emit_c_interface} {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    %c2 = arith.constant 1 : index
    scf.parallel (%i) = (%c0) to (%c2) step (%c1) {
      %ii = arith.index_cast %i : index to i64
      %pA = rmem.llvm.getelementptr %arg0[%ii []] : (!llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>, i64) -> !llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>
      %A = rmem.llvm.load %pA : (!llvm.ptr<!rmem.rmref<1, memref<64512x512xf32>>>) -> !rmem.rmref<1, memref<64512x512xf32>>
      %pout = rmem.llvm.getelementptr %out[%ii []] : (!llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>, i64) -> !llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>> 
      %C = rmem.llvm.load %pout : (!llvm.ptr<!rmem.rmref<2, memref<64512x512xf32>>>) -> !rmem.rmref<2, memref<64512x512xf32>>
      func.call @main_graph(%C, %A, %arg1) : (!rmem.rmref<2, memref<64512x512xf32>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>) -> ()
    } {N_thread = 1 : i64}
    return
  }

  func.func @main_graph(%arg0: !rmem.rmref<2, memref<64512x512xf32>>, %arg1: !rmem.rmref<1, memref<64512x512xf32>>, %arg2: memref<512x512xf32>) attributes {input_names = ["X1", "X2"], llvm.emit_c_interface, output_names = ["Y"]} {
    %c1 = arith.constant 1 : index
