...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  func.func @main_graph(%arg0: memref<64512x512xf32>, %arg1: memref<64512x512xf32>, %arg2: memref<512x512xf32>) attributes {input_names = ["X1", "X2"], llvm.emit_c_interface, operand_types = [!rmem.rmref<2, memref<64512x512xf32>>, !rmem.rmref<1, memref<64512x512xf32>>, memref<512x512xf32>], output_names = ["Y"], remote_target = 1 : i64} {
    ...
    affine.for %arg3 = 0 to 64512 {
      affine.for %arg4 = 0 to 512 {
        affine.store %cst, %arg0[%arg3, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>
      }
    }
    affine.for %arg3 = 0 to 64512 step 4 {
      affine.for %arg4 = 0 to 512 step 8 {
        affine.for %arg5 = 0 to 512 step 8 {
          ...
          %0 = vector.load %arg0[%arg3, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          affine.store %0, %alloca[0] {remote_check_use = 1 : i8} : memref<4xvector<8xf32>>
          %1 = arith.addi %arg3, %c1 : index
          %2 = vector.load %arg0[%1, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          affine.store %2, %alloca[1] {remote_check_use = 1 : i8} : memref<4xvector<8xf32>>
          %3 = arith.addi %arg3, %c2 : index
          %4 = vector.load %arg0[%3, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          affine.store %4, %alloca[2] {remote_check_use = 1 : i8} : memref<4xvector<8xf32>>
          %5 = arith.addi %arg3, %c3 : index
          %6 = vector.load %arg0[%5, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          ...
          affine.for %arg6 = 0 to 8 step 4 {
            ...
            %12 = memref.load %arg1[%arg3, %11] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %19 = memref.load %arg1[%arg3, %18] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %26 = memref.load %arg1[%arg3, %25] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %31 = affine.apply #map2(%arg6)
            %32 = arith.addi %31, %arg5 : index
            %33 = memref.load %arg1[%arg3, %32] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %38 = memref.load %arg1[%1, %11] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %43 = memref.load %arg1[%1, %18] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %48 = memref.load %arg1[%1, %25] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %53 = memref.load %arg1[%1, %32] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %58 = memref.load %arg1[%3, %11] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %63 = memref.load %arg1[%3, %18] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %68 = memref.load %arg1[%3, %25] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %73 = memref.load %arg1[%3, %32] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %78 = memref.load %arg1[%5, %11] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %83 = memref.load %arg1[%5, %18] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %88 = memref.load %arg1[%5, %25] {remote_check_use = 1 : i8} : memref<64512x512xf32>
            ...
            %93 = memref.load %arg1[%5, %32] {remote_check_use = 1 : i8} : memref<64512x512xf32>
          ...
          vector.store %7, %arg0[%arg3, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          %8 = affine.load %alloca[1] : memref<4xvector<8xf32>>
          vector.store %8, %arg0[%1, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          %9 = affine.load %alloca[2] : memref<4xvector<8xf32>>
          vector.store %9, %arg0[%3, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
          %10 = affine.load %alloca[3] : memref<4xvector<8xf32>>
          vector.store %10, %arg0[%5, %arg4] {remote_check_use = 1 : i8} : memref<64512x512xf32>, vector<8xf32>
        }
      }
    }
    return
