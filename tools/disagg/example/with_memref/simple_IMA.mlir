module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  memref.global @as : memref<1xmemref<?x2xi32>> = uninitialized {
    "remote_target" =1,
    "remote_global_type"=memref<1x!rmem.rmref<1, memref<?x2xi32>>>
  }
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %2 = memref.get_global @as : memref<1xmemref<?x2xi32>> {
      "remote_target" = 1,
      "rel_types"=[memref<1x!rmem.rmref<1, memref<?x2xi32>>>]
    }
    ...
    %7 = memref.alloc(%6) {
      "remote_target" = 1,
      "rel_types" = [!rmem.rmref<1, memref<?x2xi32>>]
    } : memref<?x2xi32>
    affine.store %7, %2[0] {"remote_target"=1} : memref<1xmemref<?x2xi32>>
    ...
    scf.for %arg2 = %c0 to %8 step %c1 {
      ...
      %12 = affine.load %11[0] {
        "remote_target" = 1,
        "rel_types"=[!rmem.rmref<1, memref<?x2xi32>>]
      } : memref<1xmemref<?x2xi32>>
      memref.store %10, %12[%arg2, %c0] {"remote_target"=1} : memref<?x2xi32>
      ...
      memref.store %15, %14[%arg2, %c1] {"remote_target"=1} : memref<?x2xi32>
    }
    ...
    scf.for %arg2 = %c0 to %9 step %c1 {
      ...
      %14 = memref.load %13[%arg2, %c1] {
        "remote_target" = 1,
        "rel_types"=[i32]
      } : memref<?x2xi32>
      %15 = memref.load %13[%arg2, %c0] {
        "remote_target" = 1,
        "rel_types"=[i32]
      } : memref<?x2xi32>
