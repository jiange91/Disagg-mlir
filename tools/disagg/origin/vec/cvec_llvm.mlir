module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main() -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %21 = llvm.bitcast %0 : !llvm.ptr<struct<"class.std::vector", (struct<"struct.std::_Vector_base", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>> to !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>
    %22 = call @remote_vec_size(%21) : (!llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64
    %23 = llvm.call @printf(%20, %22) : (!llvm.ptr<i8>, i64) -> i32
    return %c0_i32 : i32
  }
  ...
  func.func @remote_vec_size(%arg0: !llvm.ptr<struct<"_Lowered_r::class.std::vector", (struct<"_Lowered_r::struct.std::_Vector_base", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl", (struct<"_Lowered_r::struct.std::_Vector_base<int, std::allocator<int>>::_Vector_impl_data", (ptr<i32>, ptr<i32>, ptr<i32>)>)>)>)>>) -> i64 {
